...
namespace TechnicalTest.Data.Migrations
{
    ...
    [Migration("20230421095235_AddedTransferModel")]
    partial class AddedTransferModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TechnicalTest.Data.Model.BankAccountFrozenStatus", b =>
                {
                    ...
                    b.ToTable("BankAccountFrozenStatuses");
                });

            modelBuilder.Entity("TechnicalTest.Data.Model.BankAccountTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
